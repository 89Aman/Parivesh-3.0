...
<span className="font-medium">Sectors/Parameters</span>
</a>
...
<p className="text-[10px] text-slate-500 truncate">MoEFCC Division</p>
</div>
...
<div>
<h2 className="text-2xl font-black text-slate-900 dark:text-slate-100 tracking-tight">Dashboard Overview</h2>
<p className="text-sm text-slate-500">Manage system users, sector parameters, and configuration templates.</p>
</div>
...
<button className="bg-primary hover:bg-primary/90 text-white px-4 py-2 rounded-lg flex items-center gap-2 text-sm font-semibold transition-all shadow-lg shadow-primary/20">
...
<div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-primary/10 shadow-sm flex flex-col justify-between">
<div className="flex justify-between items-start">
<p className="text-slate-500 text-sm font-medium">Users by Role</p>
<span className="bg-green-100 text-green-700 text-xs font-bold px-2 py-1 rounded">+12.5%</span>
</div>
...
<div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-primary/10 shadow-sm flex flex-col justify-between">
<div className="flex justify-between items-start">
<p className="text-slate-500 text-sm font-medium">Templates Configured</p>
<span className="bg-green-100 text-green-700 text-xs font-bold px-2 py-1 rounded">+5%</span>
</div>
<div className="mt-4 flex items-baseline gap-2">
<p className="text-3xl font-black text-slate-900 dark:text-slate-100">42</p>
<p className="text-slate-400 text-sm">System Wide</p>
</div>
<div className="mt-4 h-1 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
...
<div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-primary/10 shadow-sm flex flex-col justify-between">
<div className="flex justify-between items-start">
<p className="text-slate-500 text-sm font-medium">Active Sectors</p>
<span className="bg-red-100 text-red-700 text-xs font-bold px-2 py-1 rounded">-2.1%</span>
</div>
<div className="mt-4 flex items-baseline gap-2">
<p className="text-3xl font-black text-slate-900 dark:text-slate-100">18</p>
...
<h3 className="text-lg font-bold text-slate-900 dark:text-slate-100">User Management</h3>
<div className="relative w-full sm:w-80">
<span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-xl">search</span>
<input className="w-full pl-10 pr-4 py-2 text-sm bg-slate-50 dark:bg-slate-800 border-none rounded-lg focus:ring-2 focus:ring-primary/20 focus:bg-white transition-all text-slate-900 dark:text-slate-100" placeholder="Search by name, role, or ID..." type="text"/>
</div>
</div>
...
<div>
<p className="font-bold text-slate-900 dark:text-slate-100">Rajesh Sharma</p>
<p className="text-xs text-slate-500">ID: PAR-9021-X</p>
</div>
</div>
</td>
<td className="px-6 py-4">
<span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-bold bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400">
...
<div>
<p className="font-bold text-slate-900 dark:text-slate-100">Ananya Mishra</p>
<p className="text-xs text-slate-500">ID: PAR-8812-Y</p>
</div>
</div>
</td>
<td className="px-6 py-4">
...
<div>
<p className="font-bold text-slate-900 dark:text-slate-100">Karthik Verma</p>
<p className="text-xs text-slate-500">ID: PAR-7723-Z</p>
</div>
</div>
</td>
<td className="px-6 py-4">
...
<span className="text-sm font-medium text-slate-600 dark:text-slate-400">Idle</span>
</div>
</td>
<td className="px-6 py-4 text-sm text-slate-500">
                                        3 days ago
...
<div>
<p className="font-bold text-slate-900 dark:text-slate-100">Sunita Kapoor</p>
<p className="text-xs text-slate-500">ID: PAR-6541-W</p>
</div>
</div>
</td>
<td className="px-6 py-4">
...
<p className="text-xs text-slate-500">Showing 1 to 4 of 1,284 entries</p>
<div className="flex gap-2">
<button className="px-3 py-1 text-xs font-bold border border-primary/20 rounded hover:bg-primary/5 transition-all disabled:opacity-50" disabled="">Previous</button>
<button className="px-3 py-1 text-xs font-bold border border-primary text-white bg-primary rounded hover:bg-primary/90 transition-all">1</button>
<button className="px-3 py-1 text-xs font-bold border border-primary/20 rounded hover:bg-primary/5 transition-all">2</button>
<button className="px-3 py-1 text-xs font-bold border border-primary/20 rounded hover:bg-primary/5 transition-all">3</button>
<button className="px-3 py-1 text-xs font-bold border border-primary/20 rounded hover:bg-primary/5 transition-all">Next</button>
</div>
</div>
</div>
</div>
